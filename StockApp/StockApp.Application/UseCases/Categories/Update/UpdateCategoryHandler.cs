...
public sealed class UpdateCategoryHandler(
    ...
    : HandlerWithValidation<UpdateCategoryQuery>(validator), IRequestHandler<UpdateCategoryQuery, Result<CategoryDto>>
{
    public async Task<Result<CategoryDto>> Handle(UpdateCategoryQuery request, CancellationToken cancellationToken)
    {
        try
        {
